...
class PatientTestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tests = PatientTest::join('lab_tests', 'lab_tests.id', '=', 'patient_tests.test_id')
                            ...
                            ->select('patient_tests.test', 'patient_tests.price', 'patient_tests.additional_info', 'patient_tests.payment_status', 'patient_tests.created_at',
                                    'lab_tests.lab', 'lab_results.result', 'lab_results.description', 'lab_results.file',
